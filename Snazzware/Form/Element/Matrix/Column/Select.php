...
class Snazzware_Form_Element_Matrix_Column_Select extends Snazzware_Form_Element_Matrix_Column {
		
	protected $mFormHelper = 'Form_Select';
	...
	public function getOptions() { 
		return array_merge(parent::getOptions(), array('items'=>$this->getMultiOptions())); 
	}
