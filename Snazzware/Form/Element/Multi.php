 ...
 */
class Snazzware_Form_Element_Multi extends Snazzware_Form_Element_Xhtml {
    ...
    public function addMultiOption($option, $value = '')
    {
        ...
        if (!$this->_translateOption($option, $value)) {
            $this->options['items'][$option] = $value;
        }
    ...
    public function getMultiOption($option)
    {
        $option  = (string) $option;
        $this->_getMultiOptions();
        if (isset($this->options['items'][$option])) {
            $this->_translateOption($option, $this->options['items'][$option]);
            return $this->options['items'][$option];
        }
    ...
    {
        $this->_getMultiOptions();
        foreach ($this->options['items'] as $option => $value) {
    ...
    public function removeMultiOption($option)
    {
        ...
        $this->_getMultiOptions();
        if (isset($this->options['items'][$option])) {
            unset($this->options['items'][$option]);
    ...
    protected function _translateOption($option, $value)
    {
        ...
        if (!isset($this->_translated[$option]) && !empty($value)) {
            $this->options['items'][$option] = $this->_translateValue($value);
            if ($this->options['items'][$option] === $value) {
                return false;
            }
