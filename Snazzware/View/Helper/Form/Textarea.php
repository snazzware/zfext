 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Snazzware_View_Helper_Form_Textarea extends Zend_View_Helper_FormElement
{
    /**
     ...
     */
    public function Form_Textarea($name, $value = null, $attribs = null, $options = null)
    {
    	if ((isset($options['readonly']) && $options['readonly']===true) || (isset($options['editable']) && $options['editable']===false)) {    		
    		$info = $this->_getInfo($name, $value, $attribs);
	     	extract($info); // name, value, attribs, options, listsep, disable
    		
    		return "<span id='{$this->view->escape($id)}' style='white-space: pre;'>$value</span>";
    	} else {
	        $info = $this->_getInfo($name, $value, $attribs);
	        extract($info); // name, value, attribs, options, listsep, disable
