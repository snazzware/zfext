...
class Snazzware_View_Helper_Grid_Content_Checkbox extends Zend_View_Helper_FormElement {
	
	public function Grid_Content_Checkbox($name, $value = null, $attribs = null, $options = null) {
		...
		$loadingUrl = ConfigUtils::get('snazzware','image_loading_small','/images/loader-small.gif');
