...
class Snazzware_View_Helper_Grid_Filter_Text extends Zend_View_Helper_FormElement {
	
	public function Grid_Filter_Text($name, $value = null, $attribs = null, $options = null) {
