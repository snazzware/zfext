...
class Snazzware_View_Helper_Widget_Paginated_Grid_Column_Data extends Zend_View_Helper_Abstract {
	
	public function Widget_Paginated_Grid_Column_Data($row, $column) {
		$xhtml = '';
		...
		$xhtml .= "<td class='{$column->getDataClass()}' $attribstr >";
