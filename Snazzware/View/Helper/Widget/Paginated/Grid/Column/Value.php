...
class Snazzware_View_Helper_Widget_Paginated_Grid_Column_Value extends Zend_View_Helper_Abstract {
	
	public function Widget_Paginated_Grid_Column_Value($row, $column) {
		$xhtml = '';
