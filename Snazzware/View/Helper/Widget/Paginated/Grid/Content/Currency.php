...
class Snazzware_View_Helper_Widget_Paginated_Grid_Content_Currency extends Zend_View_Helper_FormElement {
	...
	public function Widget_Paginated_Grid_Content_Currency($name, $value = null, $attribs = null, $options = null) {
