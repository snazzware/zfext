...
class Snazzware_View_Helper_Widget_Paginated_Grid_Filter_Lookup extends Zend_View_Helper_FormElement {
	
	public function Widget_Paginated_Grid_Filter_Lookup($name, $value = null, $attribs = null, $options = null) {
